...
func TestParse(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "ita eng multi language tags",
			filename: "Sample.Series.S01E01.1080p.ITA-ENG.MULTI.WEBRip.x265.AAC-GRP",
			want: TorrentInfo{
				Title:      "Sample Series",
				Season:     1,
				Episode:    1,
		...
		{
			name:     "eng lat language tags",
			filename: "Sample.Movie.2024.1080p.ENG.LAT.WEB-DL.H264-GRP",
			want: TorrentInfo{
				Title:      "Sample Movie",
				Year:       2024,
				Resolution: "1080p",
		...
		{
			name:     "max source with adjacent release context",
			filename: "Show.Name.S01E01.1080p.MAX.WEB-DL.H264-GRP",
			want: TorrentInfo{
				Title:      "Show Name",
				Season:     1,
				Episode:    1,
		...
		{
			name:     "max final token stays group",
			filename: "Show.Name.S01E01.1080p.WEB-DL.H264-MAX",
			want: TorrentInfo{
				Title:      "Show Name",
				Season:     1,
				Episode:    1,
		...
		{
			name:     "now title token is not source",
			filename: "Now.2024.1080p.WEB-DL.H264-GRP",
			want: TorrentInfo{
				Title:      "Now",
				Year:       2024,
				Resolution: "1080p",
